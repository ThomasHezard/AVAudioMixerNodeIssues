...
static double DefaultHardwareSampleRate = 48000;
...
- (void)setupAudioEngine {
    ...
    [self.audioEngine connect:self.mixer1 to:self.mainMixer format:[self stereoFloat32Format:DefaultProcessingSampleRate]];
